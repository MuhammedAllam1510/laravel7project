                 ...
                 <form method="POST" action="{{route('offer.store')}}" enctype='multipart/form-data'>
                            @csrf
                             ...
                             <div class="form-group row">
                                 <label class="col-md-4 col-form-label text-md-right">{{__('message.Photo.input')}}</label>
                            ...
                            <div class="form-group row">
                             ...
                             <div class="form-group row">
                                     ...
                                     <div class="col-md-6">
                                         <input type="text" class="form-control" name="FirstName_ar">
                             ...
                             <div class="form-group row">
                                 ...
                                 <div class="col-md-6">
                                     <input type="text" class="form-control"  name="LastName_ar">
